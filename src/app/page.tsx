...
export default function Home() {
  return (
    <>
    <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center"><div className="mx-auto mb-4 flex max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border border-gray-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all hover:border-gray-300 hover:bg-white/50 ">
      <p className="text-sm font-semibold text-gray-700">
        Camro is now public!
      </p>
    </div>
    <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-6xl">
      Chat with your <span className="text-rose-700">documents</span> in seconds.
    </h1>
    <p className="mt-5 mw-w-prose text-zinc-700 sm:text-lg">
      Camro allows you to have conversations with your PDF documents. simply upload the file and start asking questions right away. 
    </p>
    ...
    {/*  VALUE PROPOSITION SECTION HERE   */}
    <div>
      <div className="relative isolate">
        <div aria-hidden="true" className="pointer-event-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80">
          ...
          className='relative left-[calc(50%-13rem)] aspect-[1155/678] w[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#c43866] opacity-40 sm-left-[calc(50%-36rem)] sm:w-[72.1875rem]'/>
        </div>
        <div>
      ...
      <div className="mb-12 px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Chatting to your PDF files has never been easier than with Camro.
          </p>
        </div>
      </div>
      {/* Steps */}
  ...
  <li className="md:flex-1">
    <div className="flex flex-col space-y-2 border-1 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
      ...
      <span className="mt-2 text-zinc-700">
        ...
        <Link href="/pricing" className="text-rose-700 underline underline-offset-2">
          pro plan
        </Link>.
      </span>
    </div>
  ...
  <li className="md:flex-1">
    <div className="flex flex-col space-y-2 border-1 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
      ...
      <span className="mt-2 text-zinc-700">
        It&apos;s that simple. Try out Camro today - It really takes less than a minute.
      </span>
    </div>
  </li>
</ol>
